...
func Routes() *http.ServeMux {
	...
	mux.HandleFunc("/signin", func(w http.ResponseWriter, r *http.Request) {
		...
		// TODO: answer here
		correctPassword := users[creds.Username].Password
		...
		claim := &Claims{
			...
			Role:     users[creds.Username].Role,
	...
	mux.HandleFunc("/admin", func(w http.ResponseWriter, r *http.Request) {
		...
		// TODO: answer here
		w.Write([]byte(fmt.Sprintf("Welcome Admin %s!", claim.Username)))
	})
	...
	mux.HandleFunc("/profile", func(w http.ResponseWriter, r *http.Request) {
		...
		// TODO: answer here
		w.Write([]byte(fmt.Sprintf("Welcome %s %s!", strings.Title(claim.Role), claim.Username)))
	})
